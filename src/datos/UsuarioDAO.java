...
public class UsuarioDAO implements CrudPaginadoInterface<Usuario> {
    ...
    @Override
    public List<Usuario> listar(String texto, int totalPorPagina, int numPagina) throws ClassNotFoundException {
        List<Usuario> registros = new ArrayList();
        try {
            ps = CON.conectar().prepareStatement("SELECT u.id, u.id_rol, r.nombre as rol_nombre, u.nombre, u.tipo_documento, "
                    + "u.num_documento, u.direccion, u.telefono, u.email, u.clave, u.activo "
