...
public class frmSeleccionarClienteVenta extends javax.swing.JDialog {
     ...
     */
    public frmSeleccionarClienteVenta(java.awt.Frame parent, frmVenta frm, boolean modal) throws ClassNotFoundException {
        super(parent, modal);
        initComponents();
...
//        this.rutaOrigen = "";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmSeleccionarClienteVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
