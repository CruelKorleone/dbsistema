...
public class frmVenta extends javax.swing.JInternalFrame {
     ...
     */
    public frmVenta(JFrame frmP) throws ClassNotFoundException, Exception {
        initComponents();
    ...
    private void crearDetalles() {
        modeloDetalles = new DefaultTableModel() {
            ...
            public void setValueAt(Object aValue, int row, int col) {
                ...
                try {
                    int cantidadD = Integer.parseInt((String) getValueAt(row, 4));
                    int stockD = Integer.parseInt((String) getValueAt(row, 3));
                    if (cantidadD > stockD) {
                        super.setValueAt(stockD, row, 4);
                        mensajeError("La cantidad es mayor a la disponibilidad en stock");
                    }
                } catch (Exception e) {
...
//        modeloDetalles = new DefaultTableModel() {
//        };
        modeloDetalles.setColumnIdentifiers(new Object[]{"Id", "Código", "Articulo", "Stock", "Cantidad", "Precio", "Descuento", "Subtotal"});
    ...
    private void initComponents() {
        ...
        btnVerVenta.setText("Ver detalle");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(btnVerVenta, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(71, 71, 71))
        ...
        txtNombreCliente.setBackground(java.awt.SystemColor.controlLtHighlight);
        ...
        txtIdCliente.setBackground(java.awt.SystemColor.controlLtHighlight);
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(txtNombreCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 455, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
...
//            lblImagen.repaint();
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        try {
            ...
            String resp = "";
            resp = this.CONTROL.insertar(Integer.parseInt(txtIdCliente.getText()), (String) cboTipoComprobante.getSelectedItem(), txtNumTimbrado.getText(), txtNumComprobante.getText(), Double.parseDouble(txtImpuesto.getText()), Double.parseDouble(txtTotal.getText()), modeloDetalles);
            if (resp.equals("OK")) {
                try {
    ...
    private void obtenerNumero() throws ClassNotFoundException {
        String tipoComprobante = (String) cboTipoComprobante.getSelectedItem();
        String timComprobante = this.CONTROL.ultimoTim(tipoComprobante);
        String numComprobante = this.CONTROL.ultimoNumero(tipoComprobante, timComprobante);
        txtNumTimbrado.setText(timComprobante);
