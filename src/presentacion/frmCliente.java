...
//                Rol seleccionado = (Rol) cboRol.getSelectedItem();
                resp = this.CONTROL.actualizar(Integer.parseInt(txtId.getText()), "Cliente", txtNombre.getText(), (String) cboTipoDocumento.getSelectedItem(), txtNumDocumento.getText(), this.DocAnt, txtDireccion.getText(), txtTelefono.getText(), txtEmail.getText());
